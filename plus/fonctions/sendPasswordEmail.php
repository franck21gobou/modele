...
function sendPasswordEmail($email)
{
    ...
    $newPassword = motDePasseAleatoire();
    ...
    <body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4;">
        <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.1); margin-top: 20px;">
            ...
            <div style="padding: 20px; color: #333333;">
                <h1 style="color: #2c3e50; font-size: 24px; margin-bottom: 20px;">Votre nouveau mot de passe</h1>
                ...
                <p style="font-size: 16px; line-height: 1.5; margin-bottom: 15px;">
                    Voici votre nouveau mot de passe pour accéder à votre compte :
                </p>
                ...
                <div style="text-align: center; margin-top: 30px;">
                    <a href="https://votredomaine.com/login" 
            ...
            <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #eeeeee; color: #666666; font-size: 14px;">
                ...
                <p style="margin-top: 10px;">
                    © ' . date('Y') . ' VotreSociété. Tous droits réservés.
                </p>
            </div>
        </div>
    </body>
    ...
    try {
        ...
        if ($sent) {
            ...
            return [
                ...
                'password' => $newPassword // À supprimer en production
            ];
        } else {
