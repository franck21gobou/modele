...
<div class="col-lg-12">
    ...
    <div class="row" style="padding: 15px;">
        ...
        <div class="col-4  " >
            ...
            <form id="barrePeriode" style="opacity: 0;">
                <input type="date" id="debutDate">
                <input type="date" id="finDate">
                <button class="btn btn-xs btn-info"><i class="oi oi-arrow-circle-right"></i></button>
            </form>
        </div>
        <div class="col-8" style="text-align: right;">
            <p class="mt-2 mb-2">
                ...
                <button class="btn btn-space btn-secondary" onclick='tabulator.download("csv", "<?= $moi_meme["titre"]?>.csv", {delimiter:";"});'>CSV <i class="fa fa-file-csv"></i></button>
